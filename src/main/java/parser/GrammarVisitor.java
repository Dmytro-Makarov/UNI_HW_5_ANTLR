...
public interface GrammarVisitor<T> extends ParseTreeVisitor<T> {
	...
	/**
	 * Visit a parse tree produced by {@link GrammarParser#argumentsNum}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitArgumentsNum(GrammarParser.ArgumentsNumContext ctx);
	/**
	 * Visit a parse tree produced by {@link GrammarParser#argumentsID}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitArgumentsID(GrammarParser.ArgumentsIDContext ctx);
}