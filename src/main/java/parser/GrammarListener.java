...
public interface GrammarListener extends ParseTreeListener {
	...
	/**
	 * Enter a parse tree produced by {@link GrammarParser#argumentsNum}.
	 * @param ctx the parse tree
	 */
	void enterArgumentsNum(GrammarParser.ArgumentsNumContext ctx);
	/**
	 * Exit a parse tree produced by {@link GrammarParser#argumentsNum}.
	 * @param ctx the parse tree
	 */
	void exitArgumentsNum(GrammarParser.ArgumentsNumContext ctx);
	/**
	 * Enter a parse tree produced by {@link GrammarParser#argumentsID}.
	 * @param ctx the parse tree
	 */
	void enterArgumentsID(GrammarParser.ArgumentsIDContext ctx);
	/**
	 * Exit a parse tree produced by {@link GrammarParser#argumentsID}.
	 * @param ctx the parse tree
	 */
	void exitArgumentsID(GrammarParser.ArgumentsIDContext ctx);
}